  ...
  configQuestions (existing) {
    return [
      ...
      },
      {
        ...
        when: answers => answers.settings.indexOf('Movie and TV directories') !== -1
      },
      {
        name: 'locations.tv',
        type: 'input',
      ...
      },
      {
        ...
        choices: ['1080p', '720p'],
        when: answers => answers.settings.indexOf('Movie quality') !== -1
      },
      {
      ...
      },
      {
        ...
        when: answers => answers.settings.indexOf('Transmission configuration') !== -1
      },
      {
      ...
      },
      {
        ...
        type: 'input',
        when: answers => answers.settings.indexOf('Pushbullet configuration') !== -1
      },
      {
      ...
      },
      {
        ...
        type: 'input',
        when: answers => answers.settings.indexOf('TMdb configuration') !== -1
      }
    ]
  }
}
